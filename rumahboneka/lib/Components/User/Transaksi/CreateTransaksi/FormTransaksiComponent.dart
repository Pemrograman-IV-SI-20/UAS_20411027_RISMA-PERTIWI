...
class _TransaksiFormState extends State<TransaksiForm> {
  var totalBayar = 0.0;
  var jumlahBeli = 0.0;
  var hargaBarang = TransaksiScreens.dataBoneka['harga'];

  Response? response;
  var dio = Dio();
  @override
  Widget build(BuildContext context) {
    print(TransaksiScreens.dataBoneka);
    return Form(
        child: Column(
      children: [
        Image.network(
          "$baseUrl/${TransaksiScreens.dataBoneka['gambar']}",
          width: 250,
          height: 250,
          fit: BoxFit.cover,
        ),
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              Text(
                "${TransaksiScreens.dataBoneka['nama']}",
              )
            ],
          ),
        ),
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              Text(
                "${TransaksiScreens.dataBoneka['tipe']}",
              )
            ],
          ),
        ),
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              Text(
                "${TransaksiScreens.dataBoneka['harga']}",
              )
            ],
          ),
        ),
        ...
        Padding(
          ...
          child: Row(
            ...
            children: [
              Text(
                "${TransaksiScreens.dataBoneka['merk']}",
              )
            ],
          ),
        ),
          ...
          press: () {
            if (totalBayar <= 0 || jumlahBeli <= 0) {
              ...
              AwesomeDialog(
                      ...
                      title: 'Peringatan',
                      desc:
                          'Yakin ingin melakukan pembelian Boneka ${TransaksiScreens.dataBoneka['nama']} ?....',
                      btnOkOnPress: () {
                        prosesTransaksi(
                            TransaksiScreens.dataBoneka['_id'],
