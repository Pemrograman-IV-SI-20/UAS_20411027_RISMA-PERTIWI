...
class FormEditBoneka extends StatefulWidget {
  @override
  _FormEditBoneka createState() => _FormEditBoneka();
}

class _FormEditBoneka extends State<FormEditBoneka> {
  TextEditingController txtNamaBoneka = TextEditingController(
          text: '${EditBonekaScreens.dataBoneka['nama']}'),
      txtTipeBoneka = TextEditingController(
          text: '${EditBonekaScreens.dataBoneka['tipe']}'),
      txtHargaBoneka = TextEditingController(
          text: '${EditBonekaScreens.dataBoneka['harga']}'),
      txtMerekBoneka = TextEditingController(
          text: '${EditBonekaScreens.dataBoneka['merk']}');
    ...
    return Form(
      child: Column(
        children: [
          ...
          image == null
              ? Image.network(
                  '$baseUrl/${EditBonekaScreens.dataBoneka['gambar']}',
                  fit: BoxFit.cover,
                )
              : Image.file(
                  image!,
          ...
          DefaultButtonCustomeColor(
            ...
            press: () {
              if (txtNamaBoneka.text == '') {
                ...
                editDataBoneka(txtNamaBoneka.text, txtTipeBoneka.text,
  ...
  void editDataBoneka(nama, tipe, harga, merk, gambar) async {
    ...
    try {
      ...
      response = await dio.put(
          '$editbarang/${EditBonekaScreens.dataBoneka['_id']}',
          data: formData);
